/*:
 ...
 Along the way, we'll be writing [AR](glossary://ar) text ✍🏽, playing some Colombian 🇨🇴 games, and even creating our very own tropical [jardincito](glossary://jardincito) 🌴. But first, *let's start with the basics*.
