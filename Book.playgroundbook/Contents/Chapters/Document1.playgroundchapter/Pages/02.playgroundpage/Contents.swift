...
/*:
 ...
 One of the main capabilities of Augmented Reality with [ARKit](glossary://arkit) is **scene understanding**. As it begins to understand your physical environment, your iPad is currently evaluating the scene over multiple frames to **detect surfaces** on which you can place 3D objects on. 🚀
...
setWWDCAttendee(name: /*#-editable-code*/"Juan Castro Varón"/*#-end-editable-code*/, location: /*#-editable-code*/"Bogotá, Co"/*#-end-editable-code*/)
